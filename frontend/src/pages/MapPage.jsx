...
const VIDEIRA_BOUNDS  = [[-27.075, -51.235], [-26.945, -51.035]]
const VIDEIRA_MIN_ZOOM = 13
...
export default function MapPage() {
  ...
  return (
    <div className="map-page" style={{ height:'100dvh', minHeight:'100svh', display:'flex', flexDirection:'column', overflow:'hidden' }}>
      <Navbar />
      <div className="map-area" style={{ flex:1, minHeight:0, position:'relative', overflow:'hidden' }}>

        {/* Top bar */}
        <div className="map-topbar" style={{ position:'absolute', top:12, left:'50%', transform:'translateX(-50%)', zIndex:1000, display:'flex', gap:8, alignItems:'center' }}>
        ...
        {/* Filters panel */}
        {showFilters && (
          <div className="fade-up map-filter-panel" style={{ position:'absolute', top:56, left:'50%', transform:'translateX(-50%)', zIndex:1000, background:'var(--bg2)', border:'1px solid var(--border)', borderRadius:14, padding:20, boxShadow:'var(--shadow-lg)', minWidth:340 }}>
        ...
        {/* FAB */}
        {user && (
          <Link to="/nova-ocorrencia" className="map-fab" style={{ position:'absolute', bottom:28, right:20, zIndex:1000, background:'var(--brand)', color:'white', borderRadius:14, padding:'12px 20px', fontFamily:'var(--font-display)', fontSize:14, fontWeight:700, display:'flex', alignItems:'center', gap:8, boxShadow:'0 4px 20px rgba(107,63,160,.4)', textDecoration:'none', transition:'all .2s' }}
        ...
        {/* Legend */}
        <div className="map-legend" style={{ position:'absolute', bottom:28, left:12, zIndex:1000, background:'var(--bg2)', border:'1px solid var(--border)', borderRadius:12, padding:'12px 16px', boxShadow:'var(--shadow)' }}>
        ...
        <div className="map-location-badge" style={{ position:'absolute', top:12, left:12, zIndex:1000, background:'var(--bg2)', border:'1px solid var(--brand-border)', borderRadius:9, padding:'7px 12px', display:'flex', alignItems:'center', gap:6, boxShadow:'var(--shadow-sm)' }}>
